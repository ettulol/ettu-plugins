...
| --- | --- | --- |
| [animate_channel_episode](#animate_channel_episode) | `characters:write` | episode: UUID; expected_version: integer; request_key: UUID; storyboard?: UUID; reuse_completed_scenes?: boolean = true; shot_timing?: "auto" \| "fixed" = "auto"; seconds_per_scene?: 4 \| 6 \| 8 = 8 |
...
Read an accessible channel, cast, role, version, ordered episode summaries, and latest_episode with its public video thumbnail preview_url when available. Use get_channel_episode for scenes. Website: /channels/{id}; Watch contains playback, while Studio groups Story, Storyboard and Activity. Reading previews never generates artwork or publishes anything.
